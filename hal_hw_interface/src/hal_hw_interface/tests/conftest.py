...
def mock_comp_obj():
    ...
    def get_pin(key):
        if key in pin_value_map:
            ...
            print(f"Returning pin {key} value={value}")
        else:
            value = pin_value_map['__default']
            print(f"Returning pin {key} DEFAULT value=0x{value:x}")
        return value

    def set_pin(key, value):
        print(f"Setting pin {key} value={value}")
...
def mock_redis_client_obj():
    ...
    def get_key(key):
        ...
        print(f"Returning redis key {key} value={value}")
        return value

    def set_key(key, value):
        print(f"Setting redis key {key} value={value}")
